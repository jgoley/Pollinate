...
// Parse.View.prototype.listenTo = function(model, ev, callback){
//         model.bind(ev, callback, this);
//         this.bindings.push({ model: model, ev: ev, callback: callback });
// }

 var Events = Parse.Events = {
  ...
  // Allow the `Parse` object to serve as a global event bus, for folks who
  // want global "pubsub" in a convenient place.
  _.extend(Parse, Events);
